...
class SkillPathException(Exception):
    """Base class for all SkillPath specific exceptions."""
...
class ResumeParseException(SkillPathException):
...
class LLMServiceException(SkillPathException):
