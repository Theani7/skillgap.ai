...
- **job_hunt_services.py**: Job matching, cover letter, project recommendations.
...
- `job_applications`: User's tracked applications (status, follow-up, location, salary, url, notes)
